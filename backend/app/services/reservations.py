...
async def calculate_total_revenue(property_id: str, tenant_id: str, month: Optional[int] = None, year: Optional[int] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        # Never invent revenue. A finance dashboard that answers 200 with made-up numbers when
        # the database is down is worse than an error, so surface it as 503 and log the cause.
